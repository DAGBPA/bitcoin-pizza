...
unsigned int GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock, const Consensus::Params& params)
{
    ...
    bool postfork = nHeight >= params.BPAHeight;
    ...
    else if (nHeight < params.BPAHeight + params.BPAPremineWindow) {
        return nProofOfWorkLimit;
    }
    else if (nHeight < params.BPAHeight + params.BPAPremineWindow + params.nPowAveragingWindow){
