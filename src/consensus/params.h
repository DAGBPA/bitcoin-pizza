...
struct Params {
    ...
    int BIP66Height;
    /** Block height at which Bitcoin Pizza hard fork becomes active */
    int BPAHeight;
    /** Premining blocks for Bitcoin Pizza hard fork **/
    int BPAPremineWindow;
    bool BPAPremineEnforceWhitelist;
    /**
    ...
    int64_t AveragingWindowTimespan() const { return nPowAveragingWindow * nPowTargetSpacing / 5; }
