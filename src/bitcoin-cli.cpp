...
std::string HelpMessageCli()
{
    ...
    strUsage += HelpMessageOpt("-convertaddress=<bitcoin_address>", _("Convert a Bitcoin address into Bitcoin Pizza address format."));
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help") || gArgs.IsArgSet("-version")) {
        ...
        if (!gArgs.IsArgSet("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  ...
                  "  bitcoin-cli [options] -convertaddress=address " + _("Convert Bitcoin address to Bitcoin Pizza address")  + "\n";
