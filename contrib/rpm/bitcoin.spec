...
Source10:	https://raw.githubusercontent.com/BitcoinPizza/BitcoinPizza/master/contrib/debian/examples/bitcoinpizza.conf
...
cp -p %{SOURCE10} ./bitcoinpizza.conf.example
tar -zxf %{SOURCE1}
...
cat <<EOF > %{buildroot}%{_tmpfilesdir}/bitcoinpizza.conf
d /run/bitcoind 0750 bitcoin bitcoin -
EOF
touch -a -m -t 201504280000 %{buildroot}%{_tmpfilesdir}/bitcoinpizza.conf
...
CONFIG_FILE="%{_sysconfdir}/bitcoin/bitcoinpizza.conf"
DATA_DIR="%{_localstatedir}/lib/bitcoin"
PID_FILE="/run/bitcoind/bpizzad.pid"
EOF
...
%doc COPYING bitcoinpizza.conf.example doc/README.md doc/bips.md doc/files.md doc/multiwallet-qt.md doc/reduce-traffic.md doc/release-notes.md doc/tor.md
...
%defattr(-,root,root,-)
%license COPYING db-%{bdbv}.NC-LICENSE
%doc COPYING bitcoinpizza.conf.example doc/README.md doc/REST-interface.md doc/bips.md doc/dnsseed-policy.md doc/files.md doc/reduce-traffic.md doc/release-notes.md doc/tor.md
%attr(0755,root,root) %{_sbindir}/bitcoind
%attr(0644,root,root) %{_tmpfilesdir}/bitcoinpizza.conf
...
%defattr(-,root,root,-)
%license COPYING
%doc COPYING bitcoinpizza.conf.example doc/README.md
