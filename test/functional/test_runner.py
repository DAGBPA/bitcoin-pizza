...
BASE_SCRIPTS= [
    ...
    # TODO(h4x3rotab): Temporarily disabled: 'p2p-compactblocks.py', 'bpa-hardfork.py'
    'segwit.py',
...
def run_tests(test_list, src_dir, build_dir, exeext, tmpdir, jobs=1, enable_coverage=False, args=[]):
    ...
    try:
        if subprocess.check_output(["pidof", "bpizzad"]) is not None:
    ...
    if "BITCOIND" not in os.environ:
        os.environ["BITCOIND"] = build_dir + '/src/bpizzad' + exeext
